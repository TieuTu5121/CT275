...
<script type="text/javascript">
	...
	function show_edit_product(id,product,e)
	{
		...
		if(e){
			...
			product_images_input.innerHTML = `<img src="${info.image}" />`;
			product_images_input.innerHTML += `<img src="${info.image2}" />`;
			product_images_input.innerHTML += `<img src="${info.image3}" />`;
			product_images_input.innerHTML += `<img src="${info.image4}" />`;
